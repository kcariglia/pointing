"""
---------------------------
Parses a KK 20m telescope pointing file and outputs it in the ODS JSON format as described in the link below:
...
ODS_PTH = "/home/k2-ops/odsutils/scripts"
...
if __name__ == "__main__":
    ...
    siteLon = -159.6651 # degrees
    siteEl = 1176.5838 # meters
    slew_az = 2.0 # degrees per second, az
